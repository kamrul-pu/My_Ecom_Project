...
#For SSl Commerze Payment Gateway
import requests
...
def payment(request):
    ...
    store_id = 'abc603bf07c282c3'
    API_Key = 'abc603bf07c282c3@ssl'
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.warning(request,f"Your Payment is Failed Please Try Again. Page will be redirected")
